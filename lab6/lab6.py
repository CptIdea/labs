...
def main(*args):
    ...
    ls = F.add(npyscreen.SelectOne,value=[0], values = ["Лаба 1","Лаба 2","Лаба 3","Лаба 4","Лаба 5"],max_height=6,exit_right=True,exit_left=True)
    ns = F.add(npyscreen.SelectOne,value=[1], values = ["Номер 1","Номер 2","Номер 3","Номер 4"],max_height=5,rely=2,relx=20,exit_right=True,exit_left=True)
